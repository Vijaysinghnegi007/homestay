  ...
  const contactInfo = [
    {
      ...
      link: "mailto:support@homestay.com",
    },
    {
    ...
    },
    {
      ...
      title: "Address",
      content: "123 HomeStay Street, San Francisco, CA 94105",
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    className="flex items-start p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
                  >
